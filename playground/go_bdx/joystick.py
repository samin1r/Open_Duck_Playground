...
# ==============================================================================
"""Joystick task for Go_bdx (headless version). (based on Berkeley Humanoid)"""
...
from . import base as go_bdx_base
...
class Joystick(go_bdx_base.GoBDXEnv):
    ...
    def _post_init(self) -> None:
        ...
        if USE_IMITATION_REWARD:
            self.PRM = PolyReferenceMotion(
                "playground/go_bdx/data/polynomial_coefficients.pkl"
            )
