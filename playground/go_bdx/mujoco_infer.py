...
from playground.go_bdx import base
...
class MjInfer:
    ...
    def get_feet_contacts(self, data):
        left_contact = self.check_contact(data, "left_foot", "floor")
        right_contact = self.check_contact(data, "right_foot", "floor")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="playground/go_bdx/xmls/scene_mjx_flat_terrain.xml",
    )
